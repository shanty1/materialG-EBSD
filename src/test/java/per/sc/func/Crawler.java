...
import per.sc.tool.util.http.HttpResult;
import per.sc.tool.util.http.HttpUtil;
import per.sc.tool.util.io.FileUtils;
import per.sc.tool.util.parser.Dom4jUtil;
import per.sc.tool.util.parser.JsoupUtil;
