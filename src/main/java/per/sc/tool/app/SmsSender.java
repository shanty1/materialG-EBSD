...
public class SmsSender {
	...
	public static int sendSmsMsg(String uid, String key, String mobilephones, String text){
		...
		String html = HttpUtil.getMethod(url, "utf-8", "utf-8").getResponseHtml();
		int i = StringUtil.parseInt(html, 0);
		return i;
	}
	...
	public static void main(String[] args) {
		System.out.println(SmsSender.sendSmsMsg("15188059625,18716057029,18654959614,15836628773,18856329159,18171656008", "同学真题收到许久了吧，我这里没有你的支付信息，如果是支付时没备注请截图给我。"));
	}
}
